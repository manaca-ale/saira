...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_cameras_rpa'), 'cameras', ['rpa'], unique=False)
    ...
    op.create_index(op.f('ix_users_rpa'), 'users', ['rpa'], unique=False)
    ...
    sa.Column('status', sa.Enum('PENDENTE', 'EM_ANALISE', 'RESOLVIDO', name='detectionstatus'), nullable=True),
    ...
    op.create_index('idx_detections_geom', 'detections', ['geom'], unique=False, postgresql_using='gist')
    op.create_index(op.f('ix_detections_camera_id'), 'detections', ['camera_id'], unique=False)
    op.create_index(op.f('ix_detections_rpa'), 'detections', ['rpa'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_detections_rpa'), table_name='detections')
    ...
    op.drop_index(op.f('ix_users_rpa'), table_name='users')
    op.drop_index(op.f('ix_users_id'), table_name='users')
    op.drop_index(op.f('ix_users_email'), table_name='users')
    op.drop_table('users')
    op.drop_index(op.f('ix_cameras_rpa'), table_name='cameras')
