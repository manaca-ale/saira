...
#
# Instalar no host saira-prod (crontab do ubuntu), domingos 04:10 BRT:
#   (crontab -l 2>/dev/null; echo '10 4 * * 0 /home/ubuntu/saira/services/yolo-worker-vm/scripts/retrain_dinov2_cron.sh >> /home/ubuntu/dinov2_retrain.log 2>&1') | crontab -
#
