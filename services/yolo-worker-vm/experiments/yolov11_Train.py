...
custom_model_name = "yolov11_new"

# Field to load your custom dataset
dataset_yaml_path = "C:/data.yaml" 

# Configuration for the base model 
# Options: 
# "yolo11n.pt"   # Nano (Fastest, ~6ms)
# "yolo11s.pt"   # Small (Balanced, ~10ms)
# "yolo11m.pt"   # Medium (General Purpose, ~20ms)
# "yolo11l.pt"   # Large (High Accuracy, ~35ms)
# "yolo11x.pt"   # XLarge (Max Accuracy, ~70ms)
...
def train_model():
    """
    Initializes and trains the YOLO11 model, then extracts and renames the weights.
    """
